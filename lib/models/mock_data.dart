...
class MockData {
  ...
  static final List<Product> products = [
    Product(
      ...
      images: [
        'assets/images/air_max_preday.png',
        'assets/images/court_vision.png',
        'assets/images/crater_impact.png',
      ],
      availableColors: [
        ProductColor(name: 'Maroon / Yellow', color: Color(0xFF5C180E)),
        ProductColor(name: 'White / Blue', color: Color(0xFFE85836)),
    ...
    Product(
      ...
      availableColors: [
        ProductColor(name: 'Summit White / Grey', color: Color(0xFFDFDFDF)),
    ...
    Product(
      ...
      images: [
        'assets/images/air_max_90.png',
        'assets/images/pegasus.png',
      ],
      availableColors: [
        ProductColor(name: 'Chalk White / Orange', color: Color(0xFFE85836)),
    ...
    Product(
      ...
      images: [
        'assets/images/space_hippie.png',
        'assets/images/crater_impact.png',
      ],
      availableColors: [
        ProductColor(name: 'Grey / Orange Volt', color: Color(0xFFE85836)),
